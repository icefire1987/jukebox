...
```
$ nodemon playerCtrl.js -- -L -opt2 -opt3
```
...
```
9 Dec 23:52:58 - [nodemon] starting `node ./playerCtrl.js fixtures/sigint.js`
```
...
For example, on `lib/playerCtrl.js` being changed:

```text
14 Apr 15:25:56 - [nodemon] files triggering change check: ../jsbin/lib/playerCtrl.js
...
14 Apr 15:25:56 - [nodemon] ../jsbin/lib/playerCtrl.js
